...
const requestController = {
    async sendMessage(userId, channelId, messageContent) {
        try {
            const result = await axios.post(`Messages/create`, {
                "ChannelId": channelId,
                "UserId": userId,
    ...
    async getServerByServerId(serverId) {
        try {
            const result = await axios.get(`Servers/server?serverId=${serverId}`);
            return result.data;
        } catch (e) {
    ...
    async getServerChannels(serverId) {
        try {
            const result = await axios.get(`Channels?serverId=${serverId}`);
            return result.data;
        } catch (e) {
    ...
    async getChannelByChannelId(channelId) {
        try {
            const result = await axios.get(`Channels/channel?channelId=${channelId}`);
            return result.data;
        } catch (e) {
    ...
    async getChannelMessages(channelId) {
        try {
            const result = await axios.get(`Messages?channelId=${channelId}`);
            return result.data;
        } catch (e) {
    ...
    async addChannelToServer(channelName, serverId) {
        try {
            const result = await axios.post(`Channels/create?channelName=${channelName}&serverId=${serverId}`);
            return result.data;
        } catch (e) {
    ...
    async deleteChannelFromServer(channelId) {
        try {
            // remove all messages from database with corresponding channelId
            const result = await axios.delete(`Messages/deleteByChannelId?channelId=${channelId}`);
            if (result) {
                // remove channel from database
                const result2 = await axios.delete(`Channels/delete?channelId=${channelId}`);
                return result2;
            }
    ...
    async deleteServer(serverId) {
        try {
            ...
            const channels = await requestController.getServerChannels(serverId);
            const channelIds = channels.map(channel => channel.channelId);

            const promiseArr = channelIds.map(channelId => requestController.deleteChannelFromServer(channelId));

            await Promise.all(promiseArr);

            await axios.delete(`Servers/delete?serverId=${serverId}`);
        } catch (e) {
    ...
    async addNewServer(serverName) {
        try {
            const result = await axios.post(`Servers/create?serverName=${serverName}`);
            return result.data;
        } catch (e) {
    ...
    async editServerName(serverId, serverName) {
        try {
            await axios.post(`Servers/editServerName?serverId=${serverId}&newName=${serverName}`);
        } catch (e) {
    ...
    async checkUserNameTaken(userName) {
        try {
            const result = await axios.get(`Users/userExists?userName=${userName}`, config);
            return result.data;
        } catch (e) {
    ...
    async addUser(userName, password) {
        try {
            await axios.post(`Users/addUser?userName=${userName}&password=${password}`);
        } catch (e) {
    ...
    async verifyUser(userName, password) {
        try {
            const result = await axios.get(`Users/verifyUser?userName=${userName}&password=${password}`);
    ...
    async getUser(userId) {
        try {
            const result = await axios.get(`Users/userByUserId?userId=${userId}`);
            return result.data;
        } catch (e) {
    ...
    async getUserByUserName(userName) {
        try {
            const result = await axios.get(`Users/userByUserName?userName=${userName}`);
            return result.data;
        } catch (e) {
